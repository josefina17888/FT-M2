...
span.innerHTML = span.innerHTML + ' Josefina';
...
function buildToDo(todo, index) {
  // Tu código acá:
//todo va a tener un description y un complete (que será true or false según corresponda)
var toDoShell = document.createElement('div');
toDoShell.className = 'toDoShell'; //un div con un class que es igual a toDoShell
...
function buildToDos(toDos) {
  ...
  var arrayToDo = toDos.map(function(todo, i){
...
function completeToDo(event) {
  ...
  //el event.target es el span
  //el event.target.id es el indice del span
  // Tu código acá:
